    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                expenseGraph.startAnimation(fromTop);
                members.startAnimation(fromTop);
                addExpense.startAnimation(fromTop);
                modifyExpense.startAnimation(fromTop);
                calculate.startAnimation(fromTop);
                tripDetail.startAnimation(fromTop);
                closeApp.startAnimation(fromTop);
